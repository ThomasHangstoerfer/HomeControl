...
/**
 * Created by thangstoerfer on 22.05.15.
 */
...
public class BarChart extends ViewGroup {
    ...
    public interface OnCurrentItemChangedListener {
        void OnCurrentItemChanged(BarChart source, int currentItem);
    }
     ...
     *                {@link de.bitcoder.homectrl.R.styleable.BarChart} as well as attributes inherited
    ...
    public BarChart(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            //
            // The R.styleable.BarChart_* constants represent the index for
            // each custom attribute in the R.styleable.BarChart array.
            mShowText = a.getBoolean(R.styleable.BarChart_showChartText, false);
            mTextY = a.getDimension(R.styleable.BarChart_labelY, 0.0f);
            ...
            mPointerRadius = a.getDimension(R.styleable.BarChart_pointerRadius, 2.0f);
            mAutoCenterInSlice = a.getBoolean(R.styleable.BarChart_autoCenterPointerInSlice, false);
        } finally {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        // on this view's children. BarChart lays out its children in onSizeChanged().
    }
    ...
    private void init() {
        ...
        if (Build.VERSION.SDK_INT >= 11) {
            mAutoCenterAnimator = ObjectAnimator.ofInt(BarChart.this, "PieRotation", 0);
        ...
        mDetector = new GestureDetector(BarChart.this.getContext(), new GestureListener());
