...
public abstract class OnStateChangedListener implements DeviceListener {
	OnOffActuator dev;
	 ...
	 * @param dev
	 */
	public OnStateChangedListener(OnOffActuator dev) {
		this.dev = dev;
		lastState = this.dev.state;
	}
